document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayCartItems() {
        ...
        document.querySelector('.shipping-fee').textContent = `Shipping: $${shippingFee.toFixed(2)}`;
        document.querySelector('.total').textContent = `Total: $${totalWithShipping.toFixed(2)}`;
    }
